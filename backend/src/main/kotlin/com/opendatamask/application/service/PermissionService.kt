...
import com.opendatamask.domain.port.input.PermissionUseCase
...
class PermissionService(
     ...
     */
    override fun getEffectivePermissions(userId: Long, workspaceId: Long): Set<WorkspacePermission> {
     ...
     */
    override fun requirePermission(userId: Long, workspaceId: Long, permission: WorkspacePermission) {
    ...
    override fun getPermissionsForUser(userId: Long, workspaceId: Long): Set<WorkspacePermission> =
