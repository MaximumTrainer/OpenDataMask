...
import com.opendatamask.domain.port.input.JobScheduleUseCase
...
class JobSchedulerService(
    ...
    override fun createSchedule(schedule: JobSchedule): JobSchedule {
    ...
    override fun updateSchedule(id: Long, schedule: JobSchedule): JobSchedule {
    ...
    override fun deleteSchedule(id: Long) = jobScheduleRepository.deleteById(id)

    override fun listSchedules(workspaceId: Long): List<JobSchedule> = jobScheduleRepository.findByWorkspaceId(workspaceId)
