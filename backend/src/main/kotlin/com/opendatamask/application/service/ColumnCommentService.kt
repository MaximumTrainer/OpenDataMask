...
class ColumnCommentService(
    ...
    override fun getComments(workspaceId: Long, tableName: String, columnName: String): List<ColumnComment> =
        commentRepository.findByWorkspaceIdAndTableNameAndColumnNameOrderByCreatedAtAsc(workspaceId, tableName, columnName)

    override fun addComment(workspaceId: Long, tableName: String, columnName: String, userId: Long, comment: String): ColumnComment {
    ...
    override fun deleteComment(commentId: Long, requestingUserId: Long) {
